...
def fetch(spec: ArchiveSpec, *, timeout: int = 120, retries: int = 5):
    headers = {'User-Agent': 'smc-ict-spot-btc-eth-1m/1.0'}; last = None
...
def main() -> int:
    ...
    parser.add_argument('--output', type=Path, default=Path('artifacts/binance_spot_btc_eth_1m'))
